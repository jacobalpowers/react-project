                        ...
                        <form id="new-item" onSubmit={onSubmit}>
                            <div id="modal-divider">
                                <div id="image-interaction">
                                    <img id="img-preview" src={inputs.img != null ? URL.createObjectURL(inputs.img) : ""}/>
                                ...
                                <div id="text-interaction">
                                    ...
                                    <p>
                                        ...
                                        <input type="number" id="release-date" name="release-date" step="1" required />
                                    </p>
                                    <p>
                                        <label for="game-rank">Rank: </label>
                                        <input type="number" id="game-rank" name="rank" step="1" required />
                                    </p>
                                    <p>
